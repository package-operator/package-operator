...
spec:
  ...
  components: PackageManifestComponentConfig
  config:
...
| `components` <br><a href="#packagemanifestcomponentconfig">PackageManifestComponentConfig</a> | Configuration for multi-component packages. If this field is not set it is assumed that the containing package is a single-component package. |
