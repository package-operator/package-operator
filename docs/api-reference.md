...
| `imagePullSecretRef` <br><a href="#secretreference">SecretReference</a> | Optional reference to in-cluster secret that will be used to pull the package image from its registry. |
