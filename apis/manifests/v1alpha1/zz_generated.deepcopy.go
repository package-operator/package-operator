...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PackageManifestConditionalFiltering) DeepCopyInto(out *PackageManifestConditionalFiltering) {
	*out = *in
	if in.NamedConditions != nil {
		in, out := &in.NamedConditions, &out.NamedConditions
...
func (in *PackageManifestConditionalFiltering) DeepCopy() *PackageManifestConditionalFiltering {
	if in == nil {
		return nil
	}
	out := new(PackageManifestConditionalFiltering)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PackageManifestSpec) DeepCopyInto(out *PackageManifestSpec) {
	*out = *in
	...
	in.ConditionalFiltering.DeepCopyInto(&out.ConditionalFiltering)
}
