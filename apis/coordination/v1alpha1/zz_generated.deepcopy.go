...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitionOrderSpec) DeepCopyInto(out *PartitionOrderSpec) {
	*out = *in
	if in.Static != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PartitionOrderSpec.
func (in *PartitionOrderSpec) DeepCopy() *PartitionOrderSpec {
	if in == nil {
		return nil
	}
	out := new(PartitionOrderSpec)
	in.DeepCopyInto(out)
	return out
}
