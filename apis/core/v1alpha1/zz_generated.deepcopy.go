...
func (in *ActiveObjectReference) DeepCopyInto(out *ActiveObjectReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActiveObjectReference.
func (in *ActiveObjectReference) DeepCopy() *ActiveObjectReference {
	if in == nil {
		return nil
	}
	out := new(ActiveObjectReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterObjectSetPhaseSpec) DeepCopyInto(out *ClusterObjectSetPhaseSpec) {
	*out = *in
	...
	in.ObjectSetTemplatePhase.DeepCopyInto(&out.ObjectSetTemplatePhase)
}
...
func (in *ClusterObjectSetPhaseStatus) DeepCopyInto(out *ClusterObjectSetPhaseStatus) {
	*out = *in
	...
	if in.ActiveObjects != nil {
		in, out := &in.ActiveObjects, &out.ActiveObjects
		*out = make([]ActiveObjectReference, len(*in))
		copy(*out, *in)
	}
}
