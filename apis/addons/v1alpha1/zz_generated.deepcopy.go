...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AddonInstallAllNamespaces) DeepCopyInto(out *AddonInstallAllNamespaces) {
	*out = *in
	out.AddonInstallCommon = in.AddonInstallCommon
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddonInstallAllNamespaces.
func (in *AddonInstallAllNamespaces) DeepCopy() *AddonInstallAllNamespaces {
	if in == nil {
		return nil
	}
	out := new(AddonInstallAllNamespaces)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AddonInstallOwnNamespace) DeepCopy() *AddonInstallOwnNamespace {
	if in == nil {
		return nil
	}
	out := new(AddonInstallOwnNamespace)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AddonInstallSpec) DeepCopyInto(out *AddonInstallSpec) {
	*out = *in
	...
	if in.OwnNamespace != nil {
		in, out := &in.OwnNamespace, &out.OwnNamespace
		*out = new(AddonInstallOwnNamespace)
		**out = **in
	}
}
