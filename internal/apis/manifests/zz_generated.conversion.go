...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PackageManifestCelMacro)(nil), (*v1alpha1.PackageManifestCelMacro)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_manifests_PackageManifestCelMacro_To_v1alpha1_PackageManifestCelMacro(a.(*PackageManifestCelMacro), b.(*v1alpha1.PackageManifestCelMacro), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.PackageManifestCelMacro)(nil), (*PackageManifestCelMacro)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_PackageManifestCelMacro_To_manifests_PackageManifestCelMacro(a.(*v1alpha1.PackageManifestCelMacro), b.(*PackageManifestCelMacro), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_manifests_PackageManifestCelMacro_To_v1alpha1_PackageManifestCelMacro(in *PackageManifestCelMacro, out *v1alpha1.PackageManifestCelMacro, s conversion.Scope) error {
	out.Name = in.Name
	out.Expression = in.Expression
	return nil
}

// Convert_manifests_PackageManifestCelMacro_To_v1alpha1_PackageManifestCelMacro is an autogenerated conversion function.
func Convert_manifests_PackageManifestCelMacro_To_v1alpha1_PackageManifestCelMacro(in *PackageManifestCelMacro, out *v1alpha1.PackageManifestCelMacro, s conversion.Scope) error {
	return autoConvert_manifests_PackageManifestCelMacro_To_v1alpha1_PackageManifestCelMacro(in, out, s)
}

func autoConvert_v1alpha1_PackageManifestCelMacro_To_manifests_PackageManifestCelMacro(in *v1alpha1.PackageManifestCelMacro, out *PackageManifestCelMacro, s conversion.Scope) error {
	out.Name = in.Name
	out.Expression = in.Expression
	return nil
}

// Convert_v1alpha1_PackageManifestCelMacro_To_manifests_PackageManifestCelMacro is an autogenerated conversion function.
func Convert_v1alpha1_PackageManifestCelMacro_To_manifests_PackageManifestCelMacro(in *v1alpha1.PackageManifestCelMacro, out *PackageManifestCelMacro, s conversion.Scope) error {
	return autoConvert_v1alpha1_PackageManifestCelMacro_To_manifests_PackageManifestCelMacro(in, out, s)
}
...
func autoConvert_manifests_PackageManifestSpec_To_v1alpha1_PackageManifestSpec(in *PackageManifestSpec, out *v1alpha1.PackageManifestSpec, s conversion.Scope) error {
	...
	out.CelMacros = *(*[]v1alpha1.PackageManifestCelMacro)(unsafe.Pointer(&in.CelMacros))
...
func autoConvert_v1alpha1_PackageManifestSpec_To_manifests_PackageManifestSpec(in *v1alpha1.PackageManifestSpec, out *PackageManifestSpec, s conversion.Scope) error {
	...
	out.CelMacros = *(*[]PackageManifestCelMacro)(unsafe.Pointer(&in.CelMacros))
