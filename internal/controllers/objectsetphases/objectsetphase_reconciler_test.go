...
func TestPhaseReconciler_Reconcile(t *testing.T) {
	...
	for i := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			r := newObjectSetPhaseReconciler(testScheme, cacheManager, factory, lookup, ownerStrategy)
...
func TestPhaseReconciler_Teardown(t *testing.T) {
	...
	for _, teardownDone := range []bool{true, false} {
		...
		t.Run(name, func(t *testing.T) {
			...
			cacheManager.On("GetWithUser", mock.Anything, mock.Anything, mock.Anything, mock.Anything).
				Return(accessor, nil)
			cacheManager.On("FreeWithUser", mock.Anything, mock.Anything, mock.Anything).Return(nil)
