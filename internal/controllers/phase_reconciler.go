...
type PhaseReconcilerFactory func(managedcache.Accessor) *PhaseReconciler
...
func NewPhaseReconcilerFactory(
	...
	return func(accessor managedcache.Accessor) *PhaseReconciler {
		return &PhaseReconciler{
			scheme:   scheme,
			accessor: accessor,
			// Dangerous: the uncached client here is not scoped.
