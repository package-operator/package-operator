...
func TestEnsureWantedNamespaces_AddonWithoutNamespaces(t *testing.T) {
	...
	stop, err := r.ensureWantedNamespaces(ctx, testutil.NewTestAddonWithoutNamespace())
...
func TestEnsureWantedNamespaces_AddonWithSingleNamespace_Collision(t *testing.T) {
	...
	ctx := context.Background()
	stop, err := r.ensureWantedNamespaces(ctx, testutil.NewTestAddonWithSingleNamespace())
	require.NoError(t, err)
	require.True(t, stop)
	c.AssertExpectations(t)
...
func TestEnsureWantedNamespaces_AddonWithMultipleNamespaces_NoCollision(t *testing.T) {
	...
	ctx := context.Background()
	stop, err := r.ensureWantedNamespaces(ctx, testutil.NewTestAddonWithMultipleNamespaces())
	require.NoError(t, err)
	require.False(t, stop)
