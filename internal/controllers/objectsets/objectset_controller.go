...
func NewObjectSetController(
	...
	scheme *runtime.Scheme,
	cacheManager managedcache.ObjectBoundAccessManager[client.Object], uc client.Reader,
	...
	return newGenericObjectSetController(
		...
		c, log, scheme, cacheManager, uc, r,
		restMapper,
	)
}
...
func newGenericObjectSetController(
	...
	scheme *runtime.Scheme,
	cacheManager managedcache.ObjectBoundAccessManager[client.Object], uncachedClient client.Reader,
...
func (c *GenericObjectSetController) handleDeletionAndArchival(
	...
	if err := c.cacheManager.FreeWithUser(ctx, constants.StaticCacheOwner(), objectSet); err != nil {
