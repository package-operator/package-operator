...
type RepoLoader func(context.Context, []manifests.PackageManifestRepository) (*packagerepository.MultiRepositoryIndex, error)
...
func loadRepo(ctx context.Context, repos []manifests.PackageManifestRepository) (*packagerepository.MultiRepositoryIndex, error) {
