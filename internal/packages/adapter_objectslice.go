...
func (a *GenericObjectSlice) SetObjects(objects []corev1alpha1.ObjectSetObject) {
	a.Objects = objects
}
...
func (a *GenericClusterObjectSlice) SetObjects(objects []corev1alpha1.ObjectSetObject) {
	a.Objects = objects
}
