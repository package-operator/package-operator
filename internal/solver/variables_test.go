...
func TestPrepareCandidateSet(t *testing.T) {
	...
	testCandConst := func(
		c solver.CandidateAccessor[mockInstallationData, solver.MockScopeData, solver.MockCandidateData],
	) []deppy.Constraint {
	...
	testInstConst := func(
		i solver.InstallationAccessor[mockInstallationData, solver.MockScopeData, solver.MockCandidateData],
	) []deppy.Constraint {
	...
	testScopeConst := func(
		s solver.ScopeAccessor[mockInstallationData, solver.MockScopeData, solver.MockCandidateData],
	) []deppy.Constraint {
	...
	inst := solver.Installation[mockInstallationData, solver.MockScopeData, solver.MockCandidateData]{
		Data: iData,
		Constrainers: []solver.InstallationConstrainer[mockInstallationData, solver.MockScopeData, solver.MockCandidateData]{
			testInstConst,
		},
		Scopes: []solver.Scope[mockInstallationData, solver.MockScopeData, solver.MockCandidateData]{
			{
				Data: sData,
				Constrainers: []solver.ScopeConstrainer[mockInstallationData, solver.MockScopeData, solver.MockCandidateData]{
					testScopeConst,
				},
				Candidates: []solver.Candidate[mockInstallationData, solver.MockScopeData, solver.MockCandidateData]{{
					Data: cData,
					Constrainers: []solver.CandidateConstrainer[mockInstallationData, solver.MockScopeData, solver.MockCandidateData]{
						testCandConst,
					},
				}},
			},
