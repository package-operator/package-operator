...
func (t *Tree) RenderPackage(ctx context.Context, srcPath string, opts ...RenderPackageOption) (string, error) {
	...
	tmplCtx := t.getGetSpecTemplateContext(pkg, cfg)
...
func (t *Tree) getGetSpecTemplateContext(pkg *packages.Package, cfg RenderPackageConfig) packages.PackageRenderContext {
