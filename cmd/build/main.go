...
func main() {
	...
	err := errors.Join(
		...
		mgr.RegisterGoTool(ctx, "conversion-gen", "k8s.io/code-generator/cmd/conversion-gen", "0.35.4"),
		mgr.RegisterGoTool(ctx, "golangci-lint", "github.com/golangci/golangci-lint/v2/cmd/golangci-lint", "2.11.4"),
		mgr.RegisterGoTool(ctx, "k8s-docgen", "github.com/thetechnick/k8s-docgen", "0.6.4"),
		mgr.RegisterGoTool(ctx, "helm", "helm.sh/helm/v3/cmd/helm", "3.20.2"),
		mgr.RegisterGoTool(ctx, "govulncheck", "golang.org/x/vuln/cmd/govulncheck", "1.3.0"),
		mgr.Register(&Dev{}, &CI{}),
	)
	if err != nil {
