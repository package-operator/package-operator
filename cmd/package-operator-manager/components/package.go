...
import (
	...
	controllerpackages "package-operator.run/internal/controllers/packages"
...
func ProvidePackageController(
	...
	return PackageController{
		controllerpackages.NewPackageController(
			mgr.GetClient(),
...
func ProvideClusterPackageController(
	...
	return ClusterPackageController{
		controllerpackages.NewClusterPackageController(
			mgr.GetClient(),
