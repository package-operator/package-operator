...
func TestIsPKOdeploymentAvailable(t *testing.T) {
	t.Parallel()
	...
	t.Run("not found", func(t *testing.T) {
		...
		isPKODeploymentAvailable, err := isPKODeploymentAvailable(
			context.Background(), c, "")
		require.NoError(t, err)
		assert.False(t, isPKODeploymentAvailable)
	})
	...
	t.Run("available", func(t *testing.T) {
		...
		isPKODeploymentAvailable, err := isPKODeploymentAvailable(
			context.Background(), c, "")
		require.NoError(t, err)
		assert.True(t, isPKODeploymentAvailable)
	})
}
