...
func run(opts components.Options) error {
	...
	return di.Invoke(func(pkoMgr *packageOperatorManager, cacheManager managedcache.ObjectBoundAccessManager[client.Object]) error {
		// TODO: refactor?
		if err := pkoMgr.mgr.Add(cacheManager); err != nil {
			return err
		}
